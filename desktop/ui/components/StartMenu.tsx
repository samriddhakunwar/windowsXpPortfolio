        ...
        >
          ...
          >
            ...
            <div
              style={{
                background:
                  "linear-gradient(180deg, #1E6BC5 0%, #1659B3 40%, #1555AF 100%)",
                padding: "8px 10px",
                display: "flex",
                alignItems: "center",
                gap: "10px",
            ...
            <div className="flex" style={{ minHeight: "280px" }}>
              ...
              <div
                ...
                style={{ background: "#FFFFFF", padding: "4px 0" }}
              >
                {leftPanelApps.map((app) => (
                  <button
                    ...
                    style={menuItemStyle}
                    onMouseEnter={(e) => {
                      e.currentTarget.style.background = "#2B71B3";
              ...
              <div
                ...
                style={{
                  width: "180px",
                  background:
                    "linear-gradient(180deg, #4B97D7 0%, #3983C9 20%, #3983C9 80%, #2F76BE 100%)",
                  padding: "4px 0",
              ...
              >
                {rightPanelItems.map((item, i) => (
                  <button
                    ...
                    onMouseEnter={(e) => {
                      if (item.type) e.currentTarget.style.background = "rgba(0,0,0,0.18)";
                    }}
                    onMouseLeave={(e) => {
                      e.currentTarget.style.background = "transparent";
                    }}
            ...
            <div
              style={{
                background:
                  "linear-gradient(180deg, #3580CB 0%, #295EA8 50%, #25559F 100%)",
                padding: "6px 8px",
                display: "flex",
